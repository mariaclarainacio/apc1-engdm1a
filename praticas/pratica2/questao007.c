/*
7. Faça um programa em C que leia o valor da hora de trabalho e o total de horas trabalhadas no mês e calcule o salário bruto,o salario liquido, e os impostos descontados. Considere IR igual a 25% e INSS igual a 11%.
  */
...
int main() {
  ...
  printf("--------------------------------\x1b[0m\n");
  printf("Salario Bruto...: R$ \x1b[31m%14.2f\x1b[0m\n", valor_salario_bruto);
  printf("Imposto Renda...: R$ \x1b[35m%14.2f\x1b[0m\n", valor_imposto_renda);
  printf("Imposto Previ...: R$ \x1b[36m%14.2f\x1b[0m\n", valor_imposto_previdencia);
  printf("Salario Liquido.: R$ \x1b[34m%14.2f\x1b[0m\n", valor_salario_liquido);
